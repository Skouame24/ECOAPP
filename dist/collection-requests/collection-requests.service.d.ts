...
export declare class CollectionRequestsService {
    ...
    findNearbyRequests(latitude: number, longitude: number, radiusInKm?: number): Promise<unknown>;
    updateStatus(collectionId: string, preCollectorId: string, updateStatusDto: UpdateCollectionStatusDto): Promise<{
        preCollector: {
            type: import(".prisma/client").$Enums.UserType;
            latitude: number | null;
            longitude: number | null;
