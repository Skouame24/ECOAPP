...
let SupabaseStrategy = SupabaseStrategy_1 = class SupabaseStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    constructor(configService) {
        ...
        this.logger = new common_1.Logger(SupabaseStrategy_1.name);
    }
